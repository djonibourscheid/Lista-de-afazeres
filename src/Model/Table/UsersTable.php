...
class UsersTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->notEmptyString('retype_password', 'Campo obrigatório.')
            ->sameAs('retype_password', 'password', 'As senhas não são iguais.');
    ...
    {
        $rules->add($rules->isUnique(['email'], 'Este e-mail já está em uso. Tente outro.'));
